package com.example.demo.dao.userInfo.req;
...
public class UserInfoReq {
    ...
    public Integer getUCertno() {
        return uCertno;
    }

    public void setUCertno(Integer uCertno){
    ...
    public String getUUserState() {
        return uUserState;
    }

    public void setUUserState(String uUserState){
        this.uUserState = uUserState;
    }
